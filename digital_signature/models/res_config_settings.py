...
class ResConfigSettings(models.TransientModel):
    ...
    is_show_digital_sign_task = fields.Boolean(
        config_parameter='digital_signature.is_show_digital_sign_task',
        help="Show digital signature for project tasks.")
    is_enable_options_task = fields.Boolean(
        config_parameter='digital_signature.is_enable_options_task',
        help="Enable options for digital signatures on project tasks.")
    is_confirm_sign_task = fields.Boolean(
        config_parameter='digital_signature.is_confirm_sign_task',
        help="Require confirmation for digital signatures on project tasks.")
